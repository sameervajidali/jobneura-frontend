...
export function Topbar({ onOpenSidebar }) {
  ...
  return (
    <header
      className="h-16 flex items-center justify-between bg-white dark:bg-gray-900 shadow-sm px-4 md:px-6 border-b border-gray-200 dark:border-gray-800"
    ...
    >
      ...
      {/* Dashboard Title */}
      <h1 className="text-lg md:text-xl font-bold tracking-tight text-gray-700 dark:text-gray-100 truncate ml-2 md:ml-0">
        Dashboard
      </h1>
      ...
      <div className="flex items-center gap-2 md:gap-4 ml-auto">
        {/* Notification Bell */}
        <button className="relative group hover:bg-indigo-50 dark:hover:bg-gray-800 rounded-full p-2 transition">
        ...
        {/* Dark Mode Toggle */}
        <button
          className="rounded-full p-2 hover:bg-indigo-50 dark:hover:bg-gray-800 transition"
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-900 rounded-xl shadow-2xl py-2 z-40 animate-fade-in-up ring-1 ring-gray-200 dark:ring-gray-800">
              ...
              <Link
                ...
                className="flex items-center px-4 py-2 text-sm hover:bg-indigo-50 dark:hover:bg-gray-800"
              ...
              <button
                className="flex items-center px-4 py-2 text-sm w-full hover:bg-indigo-50 dark:hover:bg-gray-800"
                onClick={() => {
                  setIsDark((v) => !v);
                  setDropdownOpen(false);
                }}
