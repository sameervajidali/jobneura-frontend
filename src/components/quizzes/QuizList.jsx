...
//           console.log("subTopic for", q._id, q.subTopic);
    ...
    <>
      ...
      >
        {quizzes.map((q) => {
          ...
          // Robust subTopic extraction (handles object, string, missing)
          quizzes.forEach(q => {
  if (!q.subTopic || typeof q.subTopic !== "object" || !q.subTopic.name)
    console.warn("BAD QUIZ!", q);
  else
    console.log("OK QUIZ", q.subTopic.name);
});
