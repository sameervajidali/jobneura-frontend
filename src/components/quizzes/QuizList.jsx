...
//                 ? q.questions.length
//                 : q.totalMarks ?? 0}{" "}
//               Questions &middot; {q.duration || 0} min
//             </p>
        ...
        {quizzes.map((q) => (
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-1">
              {typeof q.totalMarks === 'number' ? q.totalMarks : 0} Questions &middot;{" "}
              {q.duration || 0} min
            </p>
            ...
            <div className="mt-4 flex items-center text-sm text-gray-500 gap-2">
              ...
              {(typeof q.attempts === "number" ? q.attempts : 0)} attempts
            </div>

            {/* Future stats like completion or average score */}
            {/* 
