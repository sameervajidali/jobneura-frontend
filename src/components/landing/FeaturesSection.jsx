...
//             <div
//               key={index}
//               className="flex flex-col items-center text-center bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 duration-300 border border-gray-100 hover:border-indigo-300"
//             >
//               {/* Icon Circle */}
//               <div className="w-16 h-16 flex items-center justify-center rounded-full bg-indigo-100 text-indigo-600 mb-6 text-2xl shadow-sm">
//                 {feature.icon}
//               </div>
