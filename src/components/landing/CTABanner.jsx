...
// function CTABanner() {
//   return (
//     <section className="py-20 bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-500 text-white text-center relative overflow-hidden">
...
//       <Link
//         to="/register"
//         className="inline-block mt-4 px-8 py-4 bg-white text-indigo-600 font-bold rounded-full text-lg hover:bg-gray-100 transition-all"
//       >
//         Get Started Free
//       </Link>

//       {/* Divider */}
//       <div className="border-t border-white/30 my-12 mx-auto w-1/2"></div>
