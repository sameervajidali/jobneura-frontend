...
export default function Topbar() {
  ...
  return (
    <header className="flex items-center justify-between bg-white dark:bg-gray-800 border-b dark:border-gray-700 px-6 py-4">
      {/* Left side: Brand + Greeting */}
      <div className="flex items-center space-x-6">
        {/* Brand */}
        <Link to="/admin" className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">
          JobNeura
        </Link>
      ...
      <div className="flex items-center space-x-4">
        {/* Notifications */}
        <button type="button" className="text-gray-600 dark:text-gray-300 text-xl p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700">
          <FaBell />
        ...
        <button
          type="button"
          onClick={() => setIsDark(d => !d)}
          className="text-gray-600 dark:text-gray-300 text-xl p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700"
          aria-label="Toggle Dark Mode"
        >
          {isDark ? <FaSun /> : <FaMoon />}
        </button>
