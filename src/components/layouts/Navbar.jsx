...
//   // "Dashboard" button only if logged in, not already there
...
//       <nav className="h-16 flex items-center max-w-7xl mx-auto px-4 sm:px-6 w-full justify-between">
//         {/* LOGO */}
//         <Link
//           to="/"
//           className="flex items-center gap-2 text-indigo-600 dark:text-indigo-400 text-xl font-extrabold whitespace-nowrap"
//         >
//           <FaRocket className="text-2xl" /> JobNeura
//         </Link>

//         {/* Center Links - Desktop */}
//         <div className="hidden lg:flex flex-1 justify-center items-center gap-7 text-base font-medium text-gray-700 dark:text-gray-100">
//           {navLinks}
//         </div>
...
//                 className="flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 w-10 h-10 border-2 border-indigo-500 shadow focus:outline-none"
...
//               {/* Dropdown */}
//               {dropdownOpen && (
//                 <div className="absolute right-0 top-14 w-64 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl py-2 z-50 ring-1 ring-gray-200 dark:ring-gray-800 animate-fade-in-up">
...
//             <Link
//               to="/register"
//               className="px-5 py-2 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold shadow-lg hover:from-indigo-600 hover:to-purple-700 transition text-base"
//             >
...
//           <aside className="absolute top-0 left-0 w-64 h-full bg-white dark:bg-gray-900 shadow-2xl p-6 flex flex-col gap-5 animate-slide-in-left">
